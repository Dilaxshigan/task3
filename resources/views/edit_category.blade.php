...
<div class="container my-5 custom-width">
    <div class="card shadow p-4">
        <form action="{{ route('update_category', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf 
            <div class="row mb-3">
                ...
                <div class="col-md-6 mt-md-3">
                    ...
                    <input type="text" class="form-control" placeholder="Category name" name="category_title" value="{{$data->category_title}}">
                </div>
            </div>
